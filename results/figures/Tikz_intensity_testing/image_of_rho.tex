...
\begin{tikzpicture}[scale=1.1,>=Latex,font=\small]
    ...
    % Common coordinates for panel labels
    \def\panelLabelX{-3.0}
    \def\panelLabelY{3.15}

    %======================================================
    % Panel A: X contained in an open hemicircle
    %======================================================
    \begin{scope}[xshift=-\shift cm]
        ...
        \node[font=\large] at (0,-3.15)
            {$\Xc$ is contained in an open hemicircle};
    \end{scope}

    %======================================================
    % Panel B: X not contained in any open hemicircle
    %======================================================
    \begin{scope}[xshift=\shift cm]
        \coordinate (O) at (0,0);
        ...
        % Panel description
        \node[font=\large] at (0,-3.15)
            {$\Xc$ is not contained in any open hemicircle};
    \end{scope}
